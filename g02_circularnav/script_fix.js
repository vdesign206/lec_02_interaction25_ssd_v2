...
const collection = [
  { title: "Cable Car",       img: "./images/img01.png" },
  { title: "Dino Fight",      img: "./images/img02.png" },
  { title: "Red Canyon",      img: "./images/img03.png" },
  { title: "Canyon Sign",     img: "./images/img04.png" },
  { title: "Golden Bridge",   img: "./images/img05.png" },
  { title: "Yosemite Valley", img: "./images/img06.png" },
  { title: "City Skyline",    img: "./images/img07.png" },
  { title: "Royal Garden",    img: "./images/img08.png" },
  { title: "Glass Pyramid",   img: "./images/img09.png" },
  { title: "Victory Arch",    img: "./images/img10.png" },
  { title: "Green Valley",     img: "./images/img11.png" },
  { title: "Snow Peak",        img: "./images/img12.png" },
  { title: "Mountain Train",   img: "./images/img13.png" },
  { title: "Gothic Cathedral", img: "./images/img14.png" },
  { title: "Marble Fountain",  img: "./images/img15.png" },
  { title: "Rustic Decor",     img: "./images/img16.png" },
  { title: "Steam Engine",     img: "./images/img17.png" },
  { title: "Striped Fish",     img: "./images/img18.png" },
  { title: "Coral Reef",       img: "./images/img19.png" },
  { title: "Alpine Range",     img: "./images/img20.png" },
  { title: "Rustic Decor",     img: "./images/img16.png" },
  { title: "Steam Engine",     img: "./images/img17.png" },
  { title: "Striped Fish",     img: "./images/img18.png" },
  { title: "Coral Reef",       img: "./images/img19.png" },
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function togglePreview(index) {
    ...
    gsap.to(gallery, {
      ...
      scale: 5,
      y: 1300,
      rotation: (rotationRadians * 180) / Math.PI + 300,
      duration: 2,
      ease: "power4.inOut",
